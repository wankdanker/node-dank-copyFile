...
exports['create and copy file'] = function (test) {
	var newFileName = 'test-file-copied.txt';
	
	writeFile(testFileName, function () {
		copyFile(testFileName, newFileName, function (err) {
			test.equal(err, null);
...
exports['create and copy file to unwritable location'] = function (test) {
...
exports['copy file that does not exist'] = function (test) {
	var newFileName = 'test-file-moved.txt';
	
	copyFile('some-file-that-does-not-exist.txt', newFileName, function (err) {
